...
3. Open `schema.sql` in phpMyAdmin and run it once. For an existing installation, also run `migrate_product_images.sql` once.
...
- Admin Stock includes `+ Add product` with details, pricing, stock, sizes, color, description, and JPEG/PNG/WebP picture upload.
